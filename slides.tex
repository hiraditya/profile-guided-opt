...
\frame{\frametitle{AutoFDO: Non Intrusive}
  \begin{itemize}
    ...
    \item Profiles are relatively resistant to code drift [Google].
  \end{itemize}
}
...
\frame{\frametitle{Challenges for non-intrusive AutoFDO...}
  \begin{itemize}
    ...
    \item Calculating accurate profile of execution paths sharing single line of code based on DWARF discriminator [Baptiste Wicht].
  \end{itemize}
}
...
\frame{\frametitle{Interesting Areas}
  Tools related:
  \begin{itemize}
    \item Extend AutoFDO infrastructure in gcc/llvm for non-branchy optimizations.
  ...
  \begin{itemize}
    ...
    \item Kernel support missing for ETM (ARM).
  \end{itemize}
